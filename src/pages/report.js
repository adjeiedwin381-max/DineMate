...
const Report = () => {
    ...
    return (
      <>
            ...
            >
              ...
              >
                <>
                  ...
                  <Typography
                    variant="h6"
                    sx={{ color: "#3f51b5", fontWeight: 900 }}
                  >
                    Cash Received
                  </Typography>
                </>
            ...
            >
              ...
              >
                <>
                  <Typography
                    variant="h4"
                    sx={{ color: "#009688", fontWeight: 700 }}
                  >
                    &#163; {card}
                  </Typography>
                  <Typography
        ...
        <Box
          className="my-2 bg-white p-4 rounded-lg shadow-md text-center"
          ...
          <Paper elevation={3} sx={{ p: 3, borderRadius: 3, mb: 4 }}>
            ...
            >
              ...
              <FormControlLabel
                ...
                control={
                  <IOSSwitch
                    checked={showWaiterSelect}
                    onChange={handleToggleWaiterSelect}
                  />
                }
          ...
          {loading ? (
            ...
            <DataGrid
              ...
              getRowClassName={(params) => {
                ...
                return !card && !cash && !balance && !total
                  ? "pending-row"
                  : "";
              }}
              sx={{
